        ...
        describe("CardAnimationOptions") {
            describe("initialization") {
                context("when initializing a card animation options object") {
                    ...
                    it("should have a reset animation spring damping of 0.4") {
                        expect(animationOptions.resetAnimationSpringDamping).to(equal(0.4))
                    }
                    
                    it("should have a reset animation spring duration of 0.6") {
                        expect(animationOptions.resetAnimationSpringDuration).to(equal(0.6))
                    }
                }
            }
